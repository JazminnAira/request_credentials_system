...
class graduation_form_table(models.Model):
    ...
    signature1 = models.CharField(max_length=100, default="UNAPPROVED")
    signature2 = models.CharField(max_length=100, default="UNAPPROVED")
    signature3 = models.CharField(max_length=100, default="UNAPPROVED")
    signature4 = models.CharField(max_length=100, default="UNAPPROVED")
    signature5 = models.CharField(max_length=100, default="UNAPPROVED")
    signature6 = models.CharField(max_length=100, default="UNAPPROVED")
    signature7 = models.CharField(max_length=100, default="UNAPPROVED")
    signature8 = models.CharField(max_length=100, default="UNAPPROVED")
    signature9 = models.CharField(max_length=100, default="UNAPPROVED")
    signature10 = models.CharField(max_length=100, default="UNAPPROVED")
    
    addsignature1 = models.CharField(max_length=100, default="UNAPPROVED")
    addsignature2 = models.CharField(max_length=100, default="UNAPPROVED")
    addsignature3 = models.CharField(max_length=100, default="UNAPPROVED")
    addsignature4 = models.CharField(max_length=100, default="UNAPPROVED")
    addsignature5 = models.CharField(max_length=100, default="UNAPPROVED")
    addsignature6 = models.CharField(max_length=100, default="UNAPPROVED")
    addsignature7 = models.CharField(max_length=100, default="UNAPPROVED")
