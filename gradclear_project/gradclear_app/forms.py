...
class Graduation_form_table(ModelForm):
    class Meta(ModelForm):
        ...
        widgets = {
            ...
            'addsubject1': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9','placeholder': 'ex.CPET16'}),
            'addsubject2': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9','placeholder': 'ex.CPET18'}),
            'addsubject3': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9','placeholder': 'ex.BET5'}),
            'addsubject4': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9','placeholder': 'ex.BET3'}),
            'addsubject5': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9','placeholder': 'ex.ELECTIVE'}),
            'addsubject6': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9','placeholder': 'ex.GEC3'}),
            'addsubject7': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9','placeholder': 'ex.GEC7'}),
            'addsubject8': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9','placeholder': 'ex.LAB1'}),
            'addsubject9': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9','placeholder': 'ex.LAB2'}),
            'addsubject10': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9','placeholder': 'ex.CPET8'}),

            'addroom1': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9','placeholder': 'ex.ROOM201'}),
            'addroom2': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9','placeholder': 'ex.ROOM202'}),
            'addroom3': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9','placeholder': 'ex.ROOM203'}),
            'addroom4': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9','placeholder': 'ex.ROOM204'}),
            'addroom5': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9','placeholder': 'ex.ROOM205'}),
            'addroom6': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9','placeholder': 'ex.ROOM206'}),
            'addroom7': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9','placeholder': 'ex.ROOM207'}),
            'addroom8': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9','placeholder': 'ex.ROOM208'}),
            'addroom9': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9','placeholder': 'ex.ROOM209'}),
            'addroom10': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9','placeholder': 'ex.ROOM210'}),
