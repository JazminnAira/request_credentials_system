...
class Graduation_form_table(ModelForm):
    class Meta(ModelForm):
        ...
        widgets = {
            ...
            'addsubject6': forms.TextInput(attrs={'class': 'form-control input-add col-m-8', 'placeholder': 'e.g.GEC3', 'disabled':'True'}),
            'addsubject7': forms.TextInput(attrs={'class': 'form-control input-add col-m-8', 'placeholder': 'e.g.GEC7', 'disabled':'True'}),
            'addsubject8': forms.TextInput(attrs={'class': 'form-control input-add col-m-8', 'placeholder': 'e.g.LAB1', 'disabled':'True'}),
            'addsubject9': forms.TextInput(attrs={'class': 'form-control input-add col-m-8', 'placeholder': 'e.g.LAB2', 'disabled':'True'}),
            'addsubject10': forms.TextInput(attrs={'class': 'form-control input-add col-m-8', 'placeholder': 'e.g.CPET8', 'disabled':'True'}),
            ...
            'addroom6': forms.TextInput(attrs={'class': 'form-control input-add col-m-8', 'placeholder': 'e.g.ROOM206', 'disabled':'True'}),
            'addroom7': forms.TextInput(attrs={'class': 'form-control input-add col-m-8', 'placeholder': 'e.g.ROOM207', 'disabled':'True'}),
            'addroom8': forms.TextInput(attrs={'class': 'form-control input-add col-m-8', 'placeholder': 'e.g.ROOM208', 'disabled':'True'}),
            'addroom9': forms.TextInput(attrs={'class': 'form-control input-add col-m-8', 'placeholder': 'e.g.ROOM209', 'disabled':'True'}),
            'addroom10': forms.TextInput(attrs={'class': 'form-control input-add col-m-8', 'placeholder': 'e.g.ROOM210', 'disabled':'True'}),
            ...
            'addday1_6': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9', 'placeholder': 'no. of days', 'disabled':'True'}),
            'addday1_7': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9', 'placeholder': 'no. of days', 'disabled':'True'}),
            'addday1_8': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9', 'placeholder': 'no. of days', 'disabled':'True'}),
            'addday1_9': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9', 'placeholder': 'no. of days', 'disabled':'True'}),
            'addday1_10': forms.TextInput(attrs={'class': 'form-control input-add col-sm-9', 'placeholder': 'no. of days', 'disabled':'True'}),
            ...
            'add_starttime1_6': TimePickerInput(attrs={'disabled':'True'}),
            'add_endtime1_6': TimePickerInput(attrs={'disabled':'True'}),
            'add_starttime1_7': TimePickerInput(attrs={'disabled':'True'}),
            'add_endtime1_7': TimePickerInput(attrs={'disabled':'True'}),
            'add_starttime1_8': TimePickerInput(attrs={'disabled':'True'}),
            'add_endtime1_8': TimePickerInput(attrs={'disabled':'True'}),
            'add_starttime1_9': TimePickerInput(attrs={'disabled':'True'}),
            'add_endtime1_9': TimePickerInput(attrs={'disabled':'True'}),
            'add_starttime1_10': TimePickerInput(attrs={'disabled':'True'}),
            'add_endtime1_10': TimePickerInput(attrs={'disabled':'True'}),
