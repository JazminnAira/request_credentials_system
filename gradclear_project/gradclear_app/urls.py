...
urlpatterns = [
     ...
     path('student_form137_update/<int:id>', views.student_form137_update, name='student_form137_update'),
     path('student_TOR_update/<int:id>', views.student_TOR_update, name='student_TOR_update'),
