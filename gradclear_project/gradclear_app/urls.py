...
urlpatterns = [
     ...
     path('alumni_form137_update/<int:id>', views.alumni_form137_update, name='alumni_form137_update'),
     path('alumni_TOR_update/<int:id>', views.alumni_TOR_update, name='alumni_TOR_update'),
