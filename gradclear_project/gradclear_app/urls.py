...
urlpatterns = [
     ...
     path('clearance_form/<str:type>/<str:req>', views.clearance_form, name='clearance_form'),
     ...
     path('student_status_update/<int:id>', views.student_status_update, name='student_status_update'),
